    ...
    for(String line: lines) {
      ...
      // we've hit the end of a measure
        ...
        for(String arrowLine : measure) {
          ...
          double timeAtStep = Utils.beatToTime(beatAtStep, metadata.beatToBpms, metadata.beatToStops);
          System.out.println("Parsing line: "+arrowLine+" @ beatAtStep "+beatAtStep+" / @ timeAtStep "+timeAtStep);
